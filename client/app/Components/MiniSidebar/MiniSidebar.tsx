  ...
  return (
    <div className="basis-[5rem] flex flex-col bg-[#f9f9f9]">
      <div className="flex items-center justify-center h-[5rem]">
        <Image src="/icon2.png" width={30} height={30} alt="logo" />
      </div>
      ...
      <div className="mt-8 flex-1 flex flex-col items-center justify-between">
        <ul className="flex flex-col gap-10">
          {navItems.map((item, index) => (
            <li key={index} className="relative group">
              ...
              {/* Hover Tooltip */}
              <span
                className="u-triangle absolute top-[50%] translate-y-[-50%]
                 left-8 text-xs pointer-events-none text-white bg-[#3aafae] px-2 py-1 
                 rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity 
                 duration-300"
              >
                {item.title}
              </span>
        ...
        <div className="mb-[1.5rem] relative group flex flex-col items-center">
          ...
          <span
            className="u-triangle text- absolute top-[95%] translate-y-[-30px] text-xs pointer-events-none text-white bg-[#3aafae] 
                       w-[70px] ml-[130px] px-2 py-1 rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity 
                       duration-300"
          >Delete All</span>
        </div>
      </div>
